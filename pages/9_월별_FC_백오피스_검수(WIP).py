...
#
# [유지/추가]
# - EXCLUDE_IDS: 중복 코스ID 중 양쪽 모두 2025-10-01 미만(시작/종료)의 코스ID는 전 탭에서 제외
...
if EXCLUDE_IDS:
    with st.expander(f"사전 제외된 코스ID(중복 & 양쪽 날짜 모두 2025-10-01 미만) — {len(EXCLUDE_IDS)}개", expanded=False):
